      ...
      <div className="bg-gray-50 rounded-lg shadow-sm p-4 border border-gray-200">
        ...
        {showFilters && filterOptions && (
          <div className="grid grid-cols-1 gap-3 text-sm">
            <div>
              <label className="block text-xs font-semibold text-gray-500 mb-1" htmlFor="well-type">Well Type</label>
              <select
                id="well-type"
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-500 mb-1" htmlFor="formation">Formation</label>
              <select
                id="formation"
                className="w-full border border-gray-300 rounded px-2 py-1.5 text-gray-700 bg-white appearance-none"
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-500 mb-1" htmlFor="trajectory">Trajectory</label>
              <select
                id="trajectory"
                className="w-full border border-gray-300 rounded px-2 py-1.5 text-gray-700 bg-white appearance-none"
                value={filters.slant || ''}
